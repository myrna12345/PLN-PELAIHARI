...
<?php $__env->startSection('title', 'Lihat Material Retur'); ?>
...
<div class="card-form-container">
    ...
    <div class="card-form-body">
            ...
            <div class="form-group-new">
                ...
                <input type="number" class="form-control-new" value="<?php echo e($item->material_keluar ?? 0); ?>" disabled>
            </div>
            <div class="form-group-new">
                <label>Jumlah Kembali (Otomatis)</label>
                <input type="number" class="form-control-new" value="<?php echo e($item->material_kembali ?? 0); ?>" disabled>
            </div>
            <div class="form-group-new">
                <label>Status Material</label>
                <input type="text" class="form-control-new" value="<?php echo e($item->status == 'baik' ? 'Baik (Andal Bagus)' : 'Rusak (Andal Rusak)'); ?>" disabled>
            </div>
            ...
            <div class="form-group-new">
                ...
                <textarea class="form-control-new" rows="3" disabled><?php echo e($item->keterangan ?? '-'); ?></textarea>
            </div>
            ...
            <div class="form-actions" style="justify-content: flex-start;">
                <a href="<?php echo e(route('material-retur.index')); ?>" class="btn-batal">Kembali</a>
            </div>
        
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\PKL\GITHUB\PLN PELAIHARI\PLN-PELAIHARI\resources\views/material_retur/show.blade.php ENDPATH**/ ?>