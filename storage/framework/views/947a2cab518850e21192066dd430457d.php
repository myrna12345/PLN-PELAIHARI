...
<div class="container-fluid">
    <aside class="sidebar">
        <div class="sidebar-header">
            <img src="<?php echo e(asset('images/logo-pln.png')); ?>" alt="Logo PLN" class="sidebar-logo">
            <h1>SIMAS-PLN</h1>
        </div>
        <ul class="sidebar-menu">
            <li><a href="#"><i class="fas fa-user-circle"></i> Profil</a></li>
            <li><a href="<?php echo e(route('dashboard')); ?>" class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>"><i class="fas fa-home"></i> Dashboard</a></li>
    ...
    <main class="main-content">
        <div class="mobile-header">
            ...
            <h2 style="font-size: 1.2rem; margin: 0; font-weight: 600;"><?php echo $__env->yieldContent('title', 'SIMAS-PLN'); ?></h2>
        </div>
