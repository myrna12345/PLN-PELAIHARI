...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIMAS-PLN'); ?></title>
...
<div class="container-fluid">
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="logo-section">
                <img src="<?php echo e(asset('images/logo-pln.png')); ?>" alt="Logo" class="sidebar-logo">
                <h1>SIMAS-PLN</h1>
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo e(route('dashboard')); ?>" class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
            
            <li class="menu-item-has-dropdown <?php echo e(request()->routeIs('material-stand-by.*') ? 'active open' : ''); ?>">
                ...
                <ul class="submenu">
                    <li><a href="<?php echo e(route('material-stand-by.index')); ?>" class="<?php echo e(request()->routeIs('material-stand-by.index') ? 'sub-active' : ''); ?>">Laporan Material</a></li>
                    <li><a href="<?php echo e(route('material-stand-by.create')); ?>" class="<?php echo e(request()->routeIs('material-stand-by.create') ? 'sub-active' : ''); ?>">Tambah Material</a></li>
                </ul>
            </li>
            <li class="menu-item-has-dropdown <?php echo e(request()->routeIs('material-retur.*') ? 'active open' : ''); ?>">
                <a class="dropdown-toggle"><i class="fas fa-undo"></i> <span>Material Retur</span><i class="fas fa-chevron-right arrow-icon"></i></a>
                <ul class="submenu">
                    <li><a href="<?php echo e(route('material-retur.index')); ?>" class="<?php echo e(request()->routeIs('material-retur.index') ? 'sub-active' : ''); ?>">Laporan Material</a></li>
                    <li><a href="<?php echo e(route('material-retur.create')); ?>" class="<?php echo e(request()->routeIs('material-retur.create') ? 'sub-active' : ''); ?>">Tambah Material</a></li>
                </ul>
            </li>
             <li class="menu-item-has-dropdown <?php echo e(request()->routeIs('material-keluar.*') ? 'active open' : ''); ?>">
                <a class="dropdown-toggle"><i class="fas fa-tools"></i> <span>Material Keluar</span><i class="fas fa-chevron-right arrow-icon"></i></a>
                <ul class="submenu">
                    <li><a href="<?php echo e(route('material_keluar.index')); ?>" class="<?php echo e(request()->routeIs('material_keluar.index') ? 'sub-active' : ''); ?>">Laporan Material</a></li>
                    <li><a href="<?php echo e(route('material_keluar.create')); ?>" class="<?php echo e(request()->routeIs('material_keluar.create') ? 'sub-active' : ''); ?>">Tambah Material</a></li>
                </ul>
            </li>
             <li class="menu-item-has-dropdown <?php echo e(request()->routeIs('material-kembali.*') ? 'active open' : ''); ?>">
                ...
                <ul class="submenu">
                    <li><a href="<?php echo e(route('material_kembali.index')); ?>" class="<?php echo e(request()->routeIs('material_kembali.index') ? 'sub-active' : ''); ?>">Laporan Material</a></li>
                    <li><a href="<?php echo e(route('material_kembali.create')); ?>" class="<?php echo e(request()->routeIs('material_kembali.create') ? 'sub-active' : ''); ?>">Tambah Material</a></li>
                </ul>
            </li>
             <li class="menu-item-has-dropdown <?php echo e(request()->routeIs('material-siaga-stand-by.*') ? 'active open' : ''); ?>">
             ...
             <li class="menu-item-has-dropdown <?php echo e(request()->routeIs('siaga-keluar.*') ? 'active open' : ''); ?>">
             ...
             <li class="menu-item-has-dropdown <?php echo e(request()->routeIs('siaga-kembali.*') ? 'active open' : ''); ?>">
    ...
    <main class="main-content">
        <header class="top-header">
            ...
            <h2 class="page-title"><?php echo $__env->yieldContent('title', 'SIMAS-PLN'); ?></h2>
        </header>
...
</html><?php /**PATH D:\KULIAH\PKL\GITHUB\PLN PELAIHARI\PLN-PELAIHARI\resources\views/layouts/app.blade.php ENDPATH**/ ?>