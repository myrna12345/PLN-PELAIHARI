    ...
    <div class="card-form-body">
        ...
        <form action="<?php echo e(route('material-stand-by.update', $item->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group-new">
                ...
                <input type="text" name="nama_petugas" id="nama_petugas" class="form-control-new" value="<?php echo e(old('nama_petugas', $item->nama_petugas)); ?>" required>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('material-stand-by.index')); ?>" class="btn-batal">Batal</a>
            </div>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\PKL\GITHUB\PLN PELAIHARI\PLN-PELAIHARI\resources\views/material_stand_by/edit.blade.php ENDPATH**/ ?>