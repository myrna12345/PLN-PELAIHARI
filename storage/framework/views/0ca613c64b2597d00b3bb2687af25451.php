...
<?php $__env->startSection('title', 'Saldo Material Stand By'); ?>
...
<div class="card-new">
    ...
    <div class="index-header">
        ...
        <form action="<?php echo e(route('material-stand-by.index')); ?>" method="GET" class="search-form">
            ...
            <a href="<?php echo e(route('material-stand-by.index')); ?>" class="btn btn-secondary btn-sm">Reset</a>
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: top;"> 
                            <?php if($item->foto_path): ?>
                                ...
                                <a href="<?php echo e(route('material-stand-by.download-foto', $item->id)); ?>" class="btn-foto-download" title="Download Foto">
                        ...
                        <td>
                            <div class="table-actions">
                                <a href="<?php echo e(route('material-stand-by.show', $item->id)); ?>" class="btn-lihat">Lihat</a>
                                <a href="<?php echo e(route('material-stand-by.edit', $item->id)); ?>" class="btn btn-edit">Edit</a>
                                <form action="<?php echo e(route('material-stand-by.destroy', $item->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                    <?php echo csrf_field(); ?>
    ...
    <div class="index-footer-form">
        <form action="<?php echo e(route('material-stand-by.download-report')); ?>" method="GET" class="form-download">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\KULIAH\PKL\GITHUB\PLN PELAIHARI\PLN-PELAIHARI\resources\views/material_stand_by/index.blade.php ENDPATH**/ ?>