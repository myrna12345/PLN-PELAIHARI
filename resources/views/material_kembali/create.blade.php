...
<div class="card-form-container mx-auto">
    ...
    <div class="card-form-body">
        <form action="{{ route('material_kembali.store') }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- Tanggal dan Waktu --}}
            <div class="form-group-new">
                <label for="tanggal_kembali">Tanggal dan Waktu</label>
                <input type="datetime-local" id="tanggal_kembali" name="tanggal_kembali" class="form-control-new" required>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const inputTanggal = document.getElementById('tanggal_kembali');
    const now = new Date();
