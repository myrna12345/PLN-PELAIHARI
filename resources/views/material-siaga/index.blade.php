...
<div class="card-new">
    ...
    <div class="index-header">
        ...
        <!-- FORM SEARCH + TANGGAL -->
        <form action="{{ route('material-siaga.index') }}" method="GET" style="display:flex; gap:15px; align-items:center;">
            ...
            <button type="submit" class="btn btn-primary" style="padding:6px 14px; border-radius:6px;">
                Cari
            </button>

            <a href="{{ route('material-siaga.index') }}" class="btn btn-secondary"
    ...
    <div style="display:flex; align-items:center; gap:20px; margin-bottom:10px;">
        ...
        <div>
            <label style="font-weight:600; display:block; margin-bottom:4px;">Dari Tanggal:</label>
            <input type="date" name="start_date" class="form-control"
                style="padding:6px; border-radius:6px;" required>
        </div>

        <div>
            <label style="font-weight:600; display:block; margin-bottom:4px;">Sampai Tanggal:</label>
            <input type="date" name="end_date" class="form-control"
                style="padding:6px; border-radius:6px;" required>
        </div>
