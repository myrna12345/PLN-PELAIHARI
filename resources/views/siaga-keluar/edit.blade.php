{{-- resources/views/siaga-keluar/edit.blade.php --}}
...
<div class="card-form-container">
    <div class="card-form-header">
        <h2>Edit Material Siaga Keluar</h2>
    </div>
    ...
    <div class="card-form-body">
        <form action="{{ route('siaga-keluar.update', $item->id) }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- KETERANGAN (WAJIB) --}}
            <div class="form-group-new">
                <label for="keterangan">Keterangan (Wajib)</label>
            ...
            <div class="form-group-new">
                ...
                <input type="text" 
                        ...
                        value="{{ old('status', $item->status ?? 'Keluar') }}" 
                        readonly 
            ...
            <div class="form-group-new">
                <label>Tanggal Dibuat (WITA)</label>
                <input type="text" 
                       class="form-control-new" 
                       style="background-color: #e9ecef; cursor: not-allowed;"
