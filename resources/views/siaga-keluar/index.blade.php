    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th>Nama Petugas</th>
                {{-- STAND METER SEBAGAI KOLOM TERPISAH --}}
                <th>Stand Meter</th>
        ...
        <tbody>
            ...
            @empty
                {{-- COLSPAN disesuaikan: 8 kolom (No, Mat&Meter, Petugas, Stand, Status, Tgl, Foto, Aksi) --}}
                <tr>
