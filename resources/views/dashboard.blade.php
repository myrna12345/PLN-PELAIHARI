...
<style>
    /* PERBAIKAN: Mengaktifkan Scroll saat Zoom */
    body, html { 
        margin: 0; 
        padding: 0; 
        min-height: 100vh; 
        /* Mengganti overflow: hidden menjadi auto agar bisa digeser */
        overflow-x: auto; 
        overflow-y: auto; 
    ...
    .dashboard-wrapper {
        /* Menggunakan min-height agar container mengikuti panjang konten */
        min-height: 100vh; 
        width: 100%;
        display: flex;
    ...
    .executive-card { 
        ...
        display: flex; 
        flex-direction: column; 
        min-height: 140px; /* Memberikan ruang minimal agar tidak gepeng */
    }

    .label-caps { font-size: 0.55rem; font-weight: 800; color: #94a3b8; text-transform: uppercase; margin-bottom: 5px; }

    /* Material List - Tetap ada scroll internal di dalam card */
    .material-list { 
        flex: 1; 
        max-height: 120px;
        overflow-y: auto; 
    ...
    .retur-split { 
        ...
        padding-top: 4px; 
        margin-top: auto; /* Memaksa footer berada di paling bawah card */
    }
...
<div class="dashboard-wrapper">
    ...
    <div class="stats-grid">
        <div class="executive-card">
            <span class="label-caps">Stok Standby</span>
        ...
        <div class="executive-card" style="border-left-color: #ef4444;">
            <span class="label-caps text-danger">Keluar (Hari Ini)</span>
            <div class="material-list">
                ...
                @empty
                    <div class="text-muted" style="font-size: 0.5rem; font-style: italic;">Tidak ada data</div>
                @endforelse
            </div>
        ...
        <div class="executive-card" style="border-left-color: #22c55e;">
            ...
            <div class="retur-split text-success"><span>Total: {{ number_format($volumeKembali) }}</span></div>
        </div>
        ...
        <div class="executive-card" style="border-left-color: #ef4444;">
            ...
            <div class="material-list">
                @foreach($listSiagaKeluar as $k)
                    <div class="material-item text-danger">
                        <span class="material-name">{{ $k->nomor_meter }}</span>
