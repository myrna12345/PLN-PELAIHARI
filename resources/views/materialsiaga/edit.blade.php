...
.btn-submit {
    background:#138A36; color:#fff; border-radius:12px; padding:12px 28px;
    font-weight:700; float:right; border:none; margin-top:14px;
    box-shadow:0 6px 14px rgba(19,138,54,0.18);
}
@media(max-width:900px){ .form-wrapper{ width:92%; padding:20px; } }
</style>
...
<div class="form-wrapper">
    ...
    <input type="number" name="jumlah_siaga_standby" class="form-control" value="{{ $data->jumlah_siaga_standby }}" required>
        ...
        <div class="field">
            ...
            <input type="datetime-local" name="tanggal" class="form-control" value="{{ $data->tanggal }}" required>
        </div>
        ...
        <div class="field">
            ...
            <div class="input-file"><input type="file" name="foto" accept="image/*"></div>
        </div>
